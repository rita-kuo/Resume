...
const Cover: React.FC<{ education: Education }> = (props) => {
    ...
    return (
        ...
        >
            <Image src="/resume/project-before.png" alt="before" fill className="-z-10"/>
            <span className="rounded-br-lg bg-teal-700 p-2 text-white">Before</span>
            <motion.div
                className='absolute left-0 top-0 h-full w-full origin-left overflow-hidden bg-[url("/resume/project-after.png")] bg-cover bg-center'
